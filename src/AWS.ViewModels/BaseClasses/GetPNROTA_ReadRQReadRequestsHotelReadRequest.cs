namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class GetPNROTA_ReadRQReadRequestsHotelReadRequest
    {

        private string cityNameField;

        private GetPNROTA_ReadRQReadRequestsHotelReadRequestAirport airportField;

        private GetPNROTA_ReadRQReadRequestsHotelReadRequestUserID userIDField;
        ...
        public GetPNROTA_ReadRQReadRequestsHotelReadRequestAirport Airport
        {
            get
            {
        ...
        public GetPNROTA_ReadRQReadRequestsHotelReadRequestUserID UserID
        {
            get
            {
