namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class GetPNROTA_ReadRQReadRequestsCruiseReadRequest
    {

        private GetPNROTA_ReadRQReadRequestsCruiseReadRequestSelectedSailing selectedSailingField;
        ...
        public GetPNROTA_ReadRQReadRequestsCruiseReadRequestSelectedSailing SelectedSailing
        {
            get
            {
