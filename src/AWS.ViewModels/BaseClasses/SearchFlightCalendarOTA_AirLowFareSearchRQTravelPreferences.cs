namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class SearchFlightCalendarOTA_AirLowFareSearchRQTravelPreferences : AirSearchPrefsType
    {

        private SearchFlightCalendarOTA_AirLowFareSearchRQTravelPreferencesFlexDatePref flexDatePrefField;
        ...
        public SearchFlightCalendarOTA_AirLowFareSearchRQTravelPreferencesFlexDatePref FlexDatePref
        {
            get
            {
