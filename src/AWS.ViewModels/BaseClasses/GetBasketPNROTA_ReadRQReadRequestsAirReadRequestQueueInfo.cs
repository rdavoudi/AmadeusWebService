namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class GetBasketPNROTA_ReadRQReadRequestsAirReadRequestQueueInfo
    {

        private GetBasketPNROTA_ReadRQReadRequestsAirReadRequestQueueInfoQueue[] queueField;
        ...
        public GetBasketPNROTA_ReadRQReadRequestsAirReadRequestQueueInfoQueue[] Queue
        {
            get
            {
