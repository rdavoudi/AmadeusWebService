namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class GetHotelPNROTA_ReadRQReadRequestsGolfReadRequest
    {

        private GetHotelPNROTA_ReadRQReadRequestsGolfReadRequestMembership[] membershipField;
        ...
        public GetHotelPNROTA_ReadRQReadRequestsGolfReadRequestMembership[] Membership
        {
            get
            {
