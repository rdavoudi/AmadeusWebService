namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class GetCarPNROTA_ReadRQReadRequestsAirReadRequestQueueInfo
    {

        private GetCarPNROTA_ReadRQReadRequestsAirReadRequestQueueInfoQueue[] queueField;
        ...
        public GetCarPNROTA_ReadRQReadRequestsAirReadRequestQueueInfoQueue[] Queue
        {
            get
            {
