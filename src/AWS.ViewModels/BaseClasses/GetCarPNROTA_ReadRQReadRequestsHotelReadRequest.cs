namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class GetCarPNROTA_ReadRQReadRequestsHotelReadRequest
    {

        private string cityNameField;

        private GetCarPNROTA_ReadRQReadRequestsHotelReadRequestAirport airportField;

        private GetCarPNROTA_ReadRQReadRequestsHotelReadRequestUserID userIDField;
        ...
        public GetCarPNROTA_ReadRQReadRequestsHotelReadRequestAirport Airport
        {
            get
            {
        ...
        public GetCarPNROTA_ReadRQReadRequestsHotelReadRequestUserID UserID
        {
            get
            {
