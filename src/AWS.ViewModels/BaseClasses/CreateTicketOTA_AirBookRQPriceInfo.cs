namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class CreateTicketOTA_AirBookRQPriceInfo : BookingPriceInfoType
    {

        private CreateTicketOTA_AirBookRQPriceInfoPricingPref[] pricingPrefField;

        private string participationLevelField;

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("PricingPref", Order = 0)]
        public CreateTicketOTA_AirBookRQPriceInfoPricingPref[] PricingPref
        {
            get
            {
