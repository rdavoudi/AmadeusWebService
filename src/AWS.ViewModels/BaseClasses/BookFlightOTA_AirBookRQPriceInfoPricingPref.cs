namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class BookFlightOTA_AirBookRQPriceInfoPricingPref
    {

        private BookFlightOTA_AirBookRQPriceInfoPricingPrefType typeField;
        ...
        public BookFlightOTA_AirBookRQPriceInfoPricingPrefType Type
        {
            get
            {
