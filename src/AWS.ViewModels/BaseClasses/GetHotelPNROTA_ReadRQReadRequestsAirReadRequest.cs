namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class GetHotelPNROTA_ReadRQReadRequestsAirReadRequest
    {
        ...
        private GetHotelPNROTA_ReadRQReadRequestsAirReadRequestTelephone telephoneField;

        private GetHotelPNROTA_ReadRQReadRequestsAirReadRequestCustLoyalty custLoyaltyField;

        private PaymentCardType creditCardInfoField;

        private TicketingInfoRS_Type ticketNumberField;

        private GetHotelPNROTA_ReadRQReadRequestsAirReadRequestQueueInfo queueInfoField;
        ...
        private GetHotelPNROTA_ReadRQReadRequestsAirReadRequestInfoToReturn infoToReturnField;

        private bool infoToReturnFieldSpecified;

        private GetHotelPNROTA_ReadRQReadRequestsAirReadRequestFF_RequestCriteria fF_RequestCriteriaField;
        ...
        public GetHotelPNROTA_ReadRQReadRequestsAirReadRequestTelephone Telephone
        {
            get
            {
        ...
        public GetHotelPNROTA_ReadRQReadRequestsAirReadRequestCustLoyalty CustLoyalty
        {
            get
            {
        ...
        public GetHotelPNROTA_ReadRQReadRequestsAirReadRequestQueueInfo QueueInfo
        {
            get
            {
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlAttributeAttribute()]
        public GetHotelPNROTA_ReadRQReadRequestsAirReadRequestInfoToReturn InfoToReturn
        {
            get
            {
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlAttributeAttribute()]
        public GetHotelPNROTA_ReadRQReadRequestsAirReadRequestFF_RequestCriteria FF_RequestCriteria
        {
            get
            {
