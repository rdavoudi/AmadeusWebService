namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class GetBasketPNROTA_ReadRQReadRequestsGolfReadRequest
    {

        private GetBasketPNROTA_ReadRQReadRequestsGolfReadRequestMembership[] membershipField;
        ...
        public GetBasketPNROTA_ReadRQReadRequestsGolfReadRequestMembership[] Membership
        {
            get
            {
