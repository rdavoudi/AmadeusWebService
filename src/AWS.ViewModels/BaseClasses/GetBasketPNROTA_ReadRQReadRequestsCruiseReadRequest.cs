namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class GetBasketPNROTA_ReadRQReadRequestsCruiseReadRequest
    {

        private GetBasketPNROTA_ReadRQReadRequestsCruiseReadRequestSelectedSailing selectedSailingField;
        ...
        public GetBasketPNROTA_ReadRQReadRequestsCruiseReadRequestSelectedSailing SelectedSailing
        {
            get
            {
