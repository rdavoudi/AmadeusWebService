namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class GetPNROTA_ReadRQReadRequestsGolfReadRequest
    {

        private GetPNROTA_ReadRQReadRequestsGolfReadRequestMembership[] membershipField;
        ...
        public GetPNROTA_ReadRQReadRequestsGolfReadRequestMembership[] Membership
        {
            get
            {
