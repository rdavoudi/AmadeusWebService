namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class GetHotelRoomRulesResponseOTA_HotelAvailRSRoomStays
    {

        private GetHotelRoomRulesResponseOTA_HotelAvailRSRoomStaysRoomStay[] roomStayField;

        private string moreIndicatorField;

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("RoomStay", Order = 0)]
        public GetHotelRoomRulesResponseOTA_HotelAvailRSRoomStaysRoomStay[] RoomStay
        {
            get
            {
