namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class CreateTicketOTA_AirBookRQFulfillment
    {
        ...
        private CreateTicketOTA_AirBookRQFulfillmentReceipt receiptField;

        private CreateTicketOTA_AirBookRQFulfillmentPaymentText[] paymentTextField;

        private CreateTicketOTA_AirBookRQFulfillmentLCCUserLogin lCCUserLoginField;
        ...
        public CreateTicketOTA_AirBookRQFulfillmentReceipt Receipt
        {
            get
            {
        ...
        public CreateTicketOTA_AirBookRQFulfillmentPaymentText[] PaymentText
        {
            get
            {
        ...
        public CreateTicketOTA_AirBookRQFulfillmentLCCUserLogin LCCUserLogin
        {
            get
            {
