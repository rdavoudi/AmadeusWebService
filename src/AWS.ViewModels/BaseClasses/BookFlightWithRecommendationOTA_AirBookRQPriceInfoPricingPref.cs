namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class BookFlightWithRecommendationOTA_AirBookRQPriceInfoPricingPref
    {

        private BookFlightWithRecommendationOTA_AirBookRQPriceInfoPricingPrefType typeField;
        ...
        public BookFlightWithRecommendationOTA_AirBookRQPriceInfoPricingPrefType Type
        {
            get
            {
