namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class GetPNROTA_ReadRQReadRequestsAirReadRequestQueueInfo
    {

        private GetPNROTA_ReadRQReadRequestsAirReadRequestQueueInfoQueue[] queueField;
        ...
        public GetPNROTA_ReadRQReadRequestsAirReadRequestQueueInfoQueue[] Queue
        {
            get
            {
