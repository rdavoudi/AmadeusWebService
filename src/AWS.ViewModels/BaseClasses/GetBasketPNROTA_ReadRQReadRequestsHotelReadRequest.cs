namespace AWS.ViewModels.BaseClasses
{
    ...
    public partial class GetBasketPNROTA_ReadRQReadRequestsHotelReadRequest
    {

        private string cityNameField;

        private GetBasketPNROTA_ReadRQReadRequestsHotelReadRequestAirport airportField;

        private GetBasketPNROTA_ReadRQReadRequestsHotelReadRequestUserID userIDField;
        ...
        public GetBasketPNROTA_ReadRQReadRequestsHotelReadRequestAirport Airport
        {
            get
            {
        ...
        public GetBasketPNROTA_ReadRQReadRequestsHotelReadRequestUserID UserID
        {
            get
            {
